...
[Compare `check-peer-dependencies` versions 4.3.4 and 5.0.0](https://github.com/christopherthielen/check-peer-dependencies/compare/4.3.4...5.0.0)

### Bug Fixes

- escape control characters in dependency diagnostics ([d3a9e7d](https://github.com/christopherthielen/check-peer-dependencies/commit/d3a9e7d))
- preserve LF line endings on Windows checkouts ([8b20d50](https://github.com/christopherthielen/check-peer-dependencies/commit/8b20d50))
- preserve readable diagnostic formatting ([99916de](https://github.com/christopherthielen/check-peer-dependencies/commit/99916de))
- prevent command injection from peer dependency metadata ([8a0d432](https://github.com/christopherthielen/check-peer-dependencies/commit/8a0d432))
- prevent denial of service from peer version ranges ([012369f](https://github.com/christopherthielen/check-peer-dependencies/commit/012369f))
- resolve project-local Windows package manager shims ([525bf6e](https://github.com/christopherthielen/check-peer-dependencies/commit/525bf6e))

- fix!: fail when peer installation leaves unresolved dependencies ([79bdc30](https://github.com/christopherthielen/check-peer-dependencies/commit/79bdc30))

### BREAKING CHANGES

- --install exits with status 1 when peers remain unsatisfied after a partial installation. Scripts that previously continued after status 0 must handle this failure. Programmatic calls also set process.exitCode to 1 in this case.
